...
const quoteContent = (props) => {
  ...
  return (
    <div className={classes.quote_contnt}>
      <ul className={classes.quote_contnt_list}>
        <li className={classes.quote_content_item}>
      ...
      <ul className={classes.quote_contnt_list}>
        ...
        <li className={`${classes.quote_content_item} ${classes.quote_content_item_tatal}`}>
          <div className={classes.flex}>
