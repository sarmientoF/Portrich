...
import { BookingsBoxPalletCancelDialog } from "../../index";
        ...
        {items.map((item, index) => (
          <div className={classes.bookings_body} key={index}>
            ...
            >
              ...
              <img
                className={classes.bookings_img}
                src={item.need_truck === true ? TruckIconInfo : TruckIconGray}
              />
            </div>
              ...
              {item.si === null ? (
                ...
                >
                  {item.need_customs_documents
                    ? "作業確認書未完了"
                    : item.need_truck && !item.need_customs_documents
                    ? "S/I・作業確認書未完了"
                    : "S/I未完了"}
                </Button>
              ) : (
...
export default BookingListBoxPallet;
