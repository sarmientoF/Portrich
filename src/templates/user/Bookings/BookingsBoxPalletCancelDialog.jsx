...
import { registerBookingCancelBoxPallet } from "./items/operations";
...
const BookingsBoxPalletCancelDialog = (props) => {
  ...
  const handleRequest = () => {
    registerBookingCancelBoxPallet(item, handleClose, handleOpen);
  };
...
export default BookingsBoxPalletCancelDialog;
