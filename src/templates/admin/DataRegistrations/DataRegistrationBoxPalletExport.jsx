...
const inputSellList = [
  ...
  createData("drayge_recovery_charge_sell", "DRC 売り", "¥"),
...
const DataRegistrationBoxPalletExport = () => {
  ...
  return (
    <div className={classes.root}>
      <div className={classes_1.block}>
        <div className={classes_1.block_title}>輸出（箱/パレット・LCL）</div>
...
export default DataRegistrationBoxPalletExport;
