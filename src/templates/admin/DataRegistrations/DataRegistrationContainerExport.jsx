...
const inputSellList = [
  ...
  createData("lss_usd_sell", "LSS 売り", "$"),
...
const initialSelectedSellPrices = inputSellList.reduce((acc, cur) => {
  acc[cur.id] = "";
  return acc;
});

const DataRegistrationContainerExport = () => {
  ...
  return (
    <div className={classes.root}>
      <div className={classes_1.block}>
        <div className={classes_1.block_title}>輸出（コンテナ・FCL）</div>
...
export default DataRegistrationContainerExport;
