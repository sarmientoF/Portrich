...
import { fetchScheduleForBoxPallet } from "./items/operations";
...
import {
  OperatorScheduleEditBoxPalletDialog,
  OperatorScheduleDeleteBoxPalletDialog,
} from "../../index";
...
const OperatorScheduleEditBoxPallet = () => {
  ...
  useEffect(() => {
    fetchScheduleForBoxPallet(location.search, setScheduleList);
  ...
  const inputSchedule = [
    ...
    createData(
      "cfs_cut_date",
      "CFS CUT",
      scheduleList.cfs_cut_date &&
        scheduleList.cfs_cut_date.replaceAll(/-/g, "/")
    ),
    createData(
      "cfs_open_date",
      "CFS OPEN",
      scheduleList.cfs_open_date &&
        scheduleList.cfs_open_date.replaceAll(/-/g, "/")
    ),
  ];
  ...
  const blankparam = {
    ...
    cfs_cut_date: scheduleList.cfs_cut_date,
    cfs_open_date: scheduleList.cfs_open_date,
...
export default OperatorScheduleEditBoxPallet;
