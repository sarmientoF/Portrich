...
import { fetchViewForQuoteBoxesOrPallets } from "./items/operations";
...
import {
  OperatorQuoteEditBoxPalletDialog,
  OperatorQuoteDeleteBoxPalletDialog,
} from "../../index";
...
const OperatorQuoteEditBoxPallet = () => {
  ...
  useEffect(() => {
    fetchViewForQuoteBoxesOrPallets(location.search, setItems);
  ...
  const titleList = [
    ...
    createTitleData("見積期限", items.estimated_deadline_date),
  ];
  ...
  const inputCostList = [
    ...
    createData("cfs_charge_jpy_buy", "CFS 買い", "¥", items.cfs_charge_jpy_buy),
    ...
    createData("afs_jpy_buy", "AFR 買い", "¥", items.afs_jpy_buy),
    createData("err_usd_buy", "GRI 買い", "$", items.err_usd_buy),
  ...
  const inputSellList = [
    ...
    createData("afs_jpy_sell", "AFR 売り", "¥", items.afs_jpy_sell),
    createData("err_usd_sell", "AFR 売り", "$", items.err_usd_sell),
...
export default OperatorQuoteEditBoxPallet;
