...
import classes_1 from "../../../dist/css/operatorquotes.module.css";
...
const OperatorQuoteBoxPalletHead = () => {
    ...
    <div className={classes.root}>
      <div className={classes_1.main_head}>
        <div className={classes_1.main_head_menu}>
          ...
          <div className={classes_1.main_head_menu_search_area2}>
...
export default OperatorQuoteBoxPalletHead;
