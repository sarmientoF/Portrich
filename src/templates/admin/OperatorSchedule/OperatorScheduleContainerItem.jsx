...
import { setScheduleContainerItems } from "./info/operations";
...
const OperatorScheduleContainerItem = (props) => {
  const { item, shipportlist, shippingcompanies } = props;
  const dispatch = useDispatch();
  const styles = useStyles();

  const currentScheduleItems = setScheduleContainerItems(
    item,
    shipportlist,
    shippingcompanies
  );
  ...
  return (
    <>
      <div className={classes.main_body_list}>
        ...
        <div className={classes.main_body_list_item}>
          {currentScheduleItems.cy_cut_date}
        </div>
        <div className={classes.main_body_list_item}>
          {currentScheduleItems.cy_open_date}
        </div>
        <div className={classes.main_body_list_item}>
...
export default OperatorScheduleContainerItem;
